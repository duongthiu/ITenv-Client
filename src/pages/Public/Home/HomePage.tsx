      ...
      <div className="relative flex w-full items-center justify-center">
        <div className="z-10 flex w-[1280px] flex-col items-center justify-center gap-20 px-5 py-[120px]">
          ...
          <div className="">
            ...
            <p className="max-w-[800px] text-center text-[1.6rem]">
          ...
          <div className="flex flex-col items-center justify-center gap-0">
            ...
            <p className="text-[1.6rem]">One place to learn, code, and connect with others, solve coding problems</p>
            <p className="mb-32 text-[1.6rem]"> Share your ideas, ask questions, and get help.</p>
