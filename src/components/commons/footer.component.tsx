      ...
      <div className="flex w-full max-w-[1440px] flex-col items-center px-5">
        <div className="grid w-full grid-cols-4 gap-8">
          <div className="col-span-2">
            <h3 className="mb-4 text-xl font-bold">ITenv</h3>
            <p className="text-sm text-gray-400">Your one-stop platform for IT learning and community interaction.</p>
          </div>
          <div>
          ...
          <div>
            <h4 className="mb-4 text-base font-semibold">Connect With Us</h4>
