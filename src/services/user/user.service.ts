...
export const getAllUser = async (queryOptions: QueryOptions): Promise<ResponsePagination<[]>> => {
  const data = await get(import.meta.env.VITE_APP_API + 'users/friend-page', { params: queryOptions });
